<template>
  <div>
    ...
    <h1 v-if="false" class="font-semibold text-3xl">Description: Welcome to Hell!</h1>
    <h2 v-if="false" class="text-2xl font-semibold">Rules:
    <center><b>YES</b></center></h2>
    <h1 class="font-semibold text-3xl text-red-800">THIS SITE IS STILL IN TESTING PHASE, <u>PLEASE</u> DO NOT USE THE PINGLISTS GENERATED BY THIS SITE K THX BYE</h1><br>
